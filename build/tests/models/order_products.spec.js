...
describe('orderProducts Model', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, orderModel.create({
                            user_id: 1,
                            status: 'active',
                        })];
                case 3:
    ...
    it('test add product to order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var orderProduct;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderProductsModel.create({
                        order_id: 1,
                        product_id: 1,
                        quantity: 5,
                    })];
