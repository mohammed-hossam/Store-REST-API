...
function createSingleUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, firstname, lastname, password, newUser, token, err_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    _a = req.body, firstname = _a.firstname, lastname = _a.lastname, password = _a.password;
                    if (!(firstname && lastname && password)) return [3 /*break*/, 2];
                ...
                case 1:
                    newUser = _b.sent();
                    token = jsonwebtoken_1.default.sign({ newUser: newUser }, tokenSecret);
                    res.status(200).json(token);
                    _b.label = 2;
                case 2: return [3 /*break*/, 4];
                case 3:
                    err_3 = _b.sent();
                    res.status(400).send('please send firstName,lastName,password in the body as json');
                    return [3 /*break*/, 4];
